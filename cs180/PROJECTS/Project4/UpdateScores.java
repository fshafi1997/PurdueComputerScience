...
/**
 * Created by farhanshafi on 12/5/16.
 */
public class UpdateScores {
    public static void updateScores() throws IOException {
        BufferedReader userDatabaseIn = new BufferedReader(new FileReader(new File("/Users/farhanshafi/Desktop/cs rough/Project4/UserDatabase.txt")));
        PrintWriter userDatabaseOut = new PrintWriter(new File("/Users/farhanshafi/Desktop/cs rough/Project4/UserDatabase.txt"));
        String fileLine;
