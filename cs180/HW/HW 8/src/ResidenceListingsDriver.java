            ...
            if (mainMenuSelection == null) {
                ...
                if (residenceType.equals(residenceTypeFindSelections[0])) {
                    ...
                    for(int i=0;i<rl.getResidences().length;i++){
                        if(rl.getResidences()[i] instanceof Apartment){
                            int y = JOptionPane.showOptionDialog(null,rl.toString(),"Find the listing",JOptionPane.YES_NO_OPTION,
                                    JOptionPane.INFORMATION_MESSAGE,null,doneNextButtons,doneNextButtons[0]);
                    ...
                    for(int i=0;i<rl.getResidences().length;i++){
                        if(rl.getResidences()[i] instanceof House){
                            int y = JOptionPane.showOptionDialog(null,rl.toString(),"Find the listing",JOptionPane.YES_NO_OPTION,
                                    JOptionPane.INFORMATION_MESSAGE,null,doneNextButtons,doneNextButtons[0]);
                            if (y == JOptionPane.YES_OPTION){
                                break;
                    ...
                    for(int i=0;i<rl.getResidences().length;i++){
                        if(rl.getResidences()[i] instanceof Residence){
                            int y = JOptionPane.showOptionDialog(null,rl.toString(),"Find the listing",JOptionPane.YES_NO_OPTION,
                                    JOptionPane.INFORMATION_MESSAGE,null,doneNextButtons,doneNextButtons[0]);
                            if (y == JOptionPane.YES_OPTION){
                                break;
